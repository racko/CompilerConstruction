...
int main(int argc, char** args) {
    {
        ...
        productions[int32_t(NT::LOC) - uint32_t(T::EPS) - 1] = {
            {uint32_t(NT::LOC), uint32_t(T::LEFTBR), uint32_t(NT::ASSIGN), uint32_t(T::RIGHTBR)},
            {uint32_t(T::ID)},
            {uint32_t(NT::LOC), uint32_t(T::PERIOD), uint32_t(T::ID)}};
        ...
        productions[uint32_t(NT::EQ) - uint32_t(T::EPS) - 1] = {{uint32_t(NT::EQ), uint32_t(T::EQ), uint32_t(NT::REL)},
                                                                {uint32_t(NT::EQ), uint32_t(T::NEQ), uint32_t(NT::REL)},
                                                                {uint32_t(NT::REL)}};
        productions[uint32_t(NT::REL) - uint32_t(T::EPS) - 1] = {
            {uint32_t(NT::EXPR), uint32_t(T::LT), uint32_t(NT::EXPR)},
            {uint32_t(NT::EXPR), uint32_t(T::LE), uint32_t(NT::EXPR)},
            {uint32_t(NT::EXPR), uint32_t(T::GE), uint32_t(NT::EXPR)},
            {uint32_t(NT::EXPR), uint32_t(T::GT), uint32_t(NT::EXPR)},
            {uint32_t(NT::EXPR)}};
        productions[uint32_t(NT::EXPR) - uint32_t(T::EPS) - 1] = {
            {uint32_t(NT::EXPR), uint32_t(T::PLUS), uint32_t(NT::TERM)},
            {uint32_t(NT::EXPR), uint32_t(T::MINUS), uint32_t(NT::TERM)},
            {uint32_t(NT::TERM)}};
        productions[uint32_t(NT::TERM) - uint32_t(T::EPS) - 1] = {
            {uint32_t(NT::TERM), uint32_t(T::TIMES), uint32_t(NT::UNARY)},
            {uint32_t(NT::TERM), uint32_t(T::DIV), uint32_t(NT::UNARY)},
            {uint32_t(NT::UNARY)}};
        ...
        productions[uint32_t(NT::FACTOR) - uint32_t(T::EPS) - 1] = {
            {uint32_t(T::LEFTPAR), uint32_t(NT::ASSIGN), uint32_t(T::RIGHTPAR)},
            {uint32_t(NT::LOC)},
            {uint32_t(T::NUM)},
            {uint32_t(T::REAL)},
            {uint32_t(T::TRUE)},
        ...
        productions[uint32_t(NT::OPTARGS) - uint32_t(T::EPS) - 1] = {{uint32_t(NT::ARGS)}, {uint32_t(T::EPS)}};
        ...
        //    auto item1 = item(G, uint32_t(NT::C) - uint32_t(T::EPS) - 1, item::String{}, item::String{uint32_t(T::C),
        //    uint32_t(NT::C)}, uint32_t(T::C)); auto item2 = item(G, uint32_t(NT::S) - uint32_t(T::EPS) - 1,
        //    item::String{}, item::String{uint32_t(NT::C), uint32_t(NT::C)}, uint32_t(T::EOI)); std::cout <<
        //    "testing... " << (item1 < item2) << std::endl;
        ...
        //    parser.parse({uint32_t(T::NUM), uint32_t(T::TIMES), uint32_t(T::LEFTPAR), uint32_t(T::NUM),
        //    uint32_t(T::PLUS), uint32_t(T::NUM), uint32_t(T::RIGHTPAR), uint32_t(T::EOI)});
        std::cout << "parsing ID[ID] = NUM + NUM" << std::endl;
        Grammar::String input({uint32_t(T::ID),
                               uint32_t(T::LEFTBR),
                               uint32_t(T::ID),
                               uint32_t(T::RIGHTBR),
                               uint32_t(T::ASSIGN),
