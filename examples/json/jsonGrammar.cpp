...
const NonterminalID<json::Grammar> json::Grammar::start = NonterminalID<json::Grammar>(NT::START); // uint32_t(NT::ASSIGN) - uint32_t(T::EPS) - 1
const TerminalID<json::Grammar> json::Grammar::eof = TerminalID<json::Grammar>(T::EOI);
const TerminalID<json::Grammar> json::Grammar::eps = TerminalID<json::Grammar>(T::EPS);
const json::type json::Grammar::numberOfNonterminals = uint32_t(NT::VALUES) + 1;
const json::type json::Grammar::numberOfTerminals = uint32_t(T::EPS) + 1;
