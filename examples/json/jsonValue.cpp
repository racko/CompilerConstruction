...
struct BlankEqual : public boost::static_visitor<bool> {
    ...
    bool operator()(const json::num_view&) const {
        return false;
    }
    bool operator()(const boost::string_view&) const {
        return false;
    }
...
struct NumEqual : public boost::static_visitor<bool> {
    const json::num_view& lhs_;
    NumEqual(const json::num_view& lhs) : lhs_(lhs) {}
    bool operator()(null) const {
        return false;
    }
    ...
    bool operator()(const json::num_view& n) const {
        return n == lhs_;
    }
    bool operator()(const boost::string_view&) const {
        return false;
...
struct StringEqual : public boost::static_visitor<bool> {
    const boost::string_view& lhs_;
    StringEqual(const boost::string_view& lhs) : lhs_(lhs) {}
    bool operator()(null) const {
        return false;
    }
    bool operator()(bool) const {
    ...
    bool operator()(const boost::string_view& s) const {
        return s == lhs_;
    }
    bool operator()(const array&) const {
        return false;
...
struct JsonEqual : public boost::static_visitor<bool> {
    ...
    bool operator()(null) const {
        return boost::apply_visitor(BlankEqual(), lhs_);
    }
    bool operator()(bool b) const {
        return boost::apply_visitor(BoolEqual(b), lhs_);
    }
    bool operator()(const json::num_view& n) const {
        return boost::apply_visitor(NumEqual(n), lhs_);
    }
    bool operator()(const boost::string_view& s) const {
        return boost::apply_visitor(StringEqual(s), lhs_);
    }
    bool operator()(const array& a) const {
        return boost::apply_visitor(ArrayEqual(a), lhs_);
    }
    bool operator()(const object& o) const {
        return boost::apply_visitor(ObjectEqual(o), lhs_);
    }
};
...
bool ObjectEqual::operator()(const object& o) const {
    return false;
    //s_ << "{";
    //if (o.first != nullptr) {
...
bool operator==(const value& lhs, const value& rhs) {
    return boost::apply_visitor(JsonEqual(lhs), rhs);
}
...
std::ostream& operator<<(std::ostream& s, const value& v) {
    struct Printer : public boost::static_visitor<> {
        ...
        void operator()(const array& a) const {
            s_ << "[";
            if (a.first != nullptr) {
                boost::apply_visitor(*this, *a.first);
                auto it = a.second;
                while (it != nullptr) {
                    auto& a_ = boost::get<array>(*it);
                    s_ << ",";
                    boost::apply_visitor(*this, *a_.first);
                    it = a_.second;
                }
            }
            s_ << "]";
