...
#include "constexpr.h"         // for vector, HashMap
#include <DFA_constexpr.h>     // for DFA, determineDeadState
...
constexpr DFA<Symbol, DfaState, TokenId, MaxNodes, MaxSymbols>
toDFA(const NFA<Symbol, NfaState, TokenId, MaxNodes, MaxSymbols, MaxTransitions, MaxResultStates>& nfa) {
    ...
    using nfa_internal_set =
        typename NFA<Symbol, NfaState, TokenId, MaxNodes, MaxSymbols, MaxTransitions, MaxResultStates>::internal_set;
